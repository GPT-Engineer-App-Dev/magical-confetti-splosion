...
**Project**: magical-confetti-splosion 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Create a wicked confetti app 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/magical-confetti-splosion.git
cd magical-confetti-splosion
npm i
